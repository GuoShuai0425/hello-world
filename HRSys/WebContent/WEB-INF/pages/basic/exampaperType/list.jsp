...
<body class="gray-bg">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div id="toolbar">
		        <button id="add" class="btn btn-success" onclick="showDialog('#myModal','添加试卷类型','exampaperType/add');">
		            <i class="glyphicon glyphicon-plus"></i> 添加
		        </button>
		        <button id="add" class="btn btn-danger" onclick="batchDelete('exampaperType/batchDel','id');">
		            <i class="glyphicon glyphicon-remove"></i> 批量删除
		        </button>
		    </div>
            <table id="exampaperTypeList"
            	data-url="exampaperType/list" data-id-field="id" data-side-pagination="server" 
                 ...
                 <div class="modal-dialog">
                     ...
                     <div class="modal-content animated bounceInRight">
                         <div class="modal-header">
	                        ...
	                        <h4 class="modal-title text-left">添加试卷类型</h4>
	                    </div>
	...
	<script type="text/javascript">
		...
		function operateFormatter(value, row, index) {
	        return [
	            '<a href="javascript:void(0)" title="Edit" onclick="showDialog(\'#myModal\',\'编辑试卷类型\',\'exampaperType/toedit?id='+row.id+'\');">',
	            '<i class="glyphicon glyphicon-pencil"></i>',
	            '</a>&nbsp;&nbsp;',
	            '<a href="javascript:void(0)" title="Remove" onclick="deleteRecord(\'exampaperType/delete\','+row.id+');">',
